...
For plain HTML, include the `typeflow.js`, plugin just before your closing `</body>` tag:
...
TypeFlow.init();
// or with debug mode
TypeFlow.init({ dev: true });
```

```html
<script src="https://cdn.jsdelivr.net/npm/typeflow@latest/dist/typeflow.min.js"></script>
```
...
```html
<h2 class="cssanimation" ca__lt-word="ca__fx-fadeIn">
...
```html
<p class="cssanimation" ca__lt-line="ca__fx-fadeIn" ca__lt-separator="dot">
...
<p
  class="cssanimation"
  ca__lt-line="ca__fx-blurIn ca__fx-bounceFromTop ca__fx-bounceX">
  First line<br />
  Second line<br />
  Third line
</p>
...
```html
<h1 class="cssanimation" ca__lt-sequence="ca__fx-fadeIn" ca__lt-delay="100">
